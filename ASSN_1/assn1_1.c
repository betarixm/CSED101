#include <stdio.h> // 표준입출력과 관련된 header를 include
...
int main() { // main에 프로그램 구현
    ...
    int MUL = 100; // 소수 둘째자리까지 표현하기 위한 보정 상수
...
int exchange(int target, int *amount){
...
int exchange_cent(int target, int *amount){
